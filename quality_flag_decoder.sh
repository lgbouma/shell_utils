...
# Description:
#   This script takes a 12-bit quality flag integer as input and performs the following:
...
#
# Parameters:
#   quality_flag: An integer representing the 12-bit quality flag.
#
# Example:
#   ./quality_flag_decoder.sh 1028
#   Output:
#     Binary representation: 010000000100
#     Bit 10 is on (S21 CP/CB)
#     Bit 2 is on (M_G <3.9)
...
binary_representation=$(printf "%012d" $(echo "obase=2; $quality_flag" | bc))
